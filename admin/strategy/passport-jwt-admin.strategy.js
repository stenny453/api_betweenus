...
let JwtAdminStrategy = class JwtAdminStrategy extends passport_1.PassportStrategy(passport_jwt_1.Strategy) {
    ...
    async validate(payload) {
        const user = await this.adminRepository.findOne({ email: payload.email });
        if (user) {
...
//# sourceMappingURL=passport-jwt-admin.strategy.js.map